...
class DelayWrapper(Wrapper):
    ...
    def reset(self, **kwargs):
        ...
        self.extended_obs = [np.zeros(self.action_dim) for _ in range(self.delay.current+1)]
        ...
        return self.extended_obs[0], np.stack(self.extended_obs[1:])
    ...
    def step(self, action):
        ...
        # Shaping the output
        output = (self.extended_obs[0], np.stack(self.extended_obs[1:]))
